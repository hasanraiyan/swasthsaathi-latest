// Mirrors the shapes streamed by `@personaai/react`'s hooks — duplicated
// locally (not imported) so these UI components have no compile-time
// dependency on the lib's own type exports.
