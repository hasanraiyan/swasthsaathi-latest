...
import { FirstAidKitIcon, UserIcon } from "@phosphor-icons/react";
...
// once its page actually exists; Phase 1's other modules (medications,
// measurements, reminders, history) join this array as they're built rather
// than linking ahead to pages that don't exist yet.
